...
<head>
    ...
    <title>Cukurucook - Edit Recipe</title>
...
<body class="bg-gray-100">
    ...
    <main class="container py-8 mx-auto">
        <section class="mb-8">
            <h1 class="mb-4 text-3xl font-semibold">Edit Recipe</h1>
            <form action="save_recipe.php" method="POST" class="max-w-lg">
                <input type="hidden" name="id" value="<?php echo $recipe['id']; ?>">
                <div class="mb-4">
                    <label class="block mb-2" for="name">Name</label>
                    <input class="w-full px-3 py-2 border rounded-md" type="text" id="name" name="name" value="<?php echo $recipe['name']; ?>" required>
                </div>
                <div class="mb-4">
                    <label class="block mb-2" for="description">Description</label>
                    <textarea class="w-full px-3 py-2 border rounded-md" id="description" name="description" rows="3" required><?php echo $recipe['description']; ?></textarea>
                </div>
                <div class="mb-4">
                    <label class="block mb-2" for="bahan">Bahan</label>
                    <textarea class="w-full px-3 py-2 border rounded-md" id="bahan" name="bahan" rows="3" required><?php echo $recipe['bahan']; ?></textarea>
                </div>
                <div class="mb-4">
                    <label class="block mb-2" for="langkah">Langkah</label>
                    <textarea class="w-full px-3 py-2 border rounded-md" id="langkah" name="langkah" rows="3" required><?php echo $recipe['langkah']; ?></textarea>
                </div>
                <div class="mb-4">
                    <label class="block mb-2" for="kesulitan">Kesulitan</label>
                    <input class="w-full px-3 py-2 border rounded-md" type="text" id="kesulitan" name="kesulitan" value="<?php echo $recipe['kesulitan']; ?>">
                </div>
                <div class="mb-4">
                    <label class="block mb-2" for="image_url">Image URL</label>
                    <input class="w-full px-3 py-2 border rounded-md" type="text" id="image_url" name="image_url" value="<?php echo $recipe['image_url']; ?>">
                </div>
