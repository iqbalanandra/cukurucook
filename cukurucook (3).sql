...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2024 at 12:06 PM
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `level`, `status`) VALUES
(999, 'ahyar', '321', 'ahyar@gmail.com', 'user', 'active'),
(1000, 'iqbal', '123', 'iqbal@gmail.com', 'user', 'deactivate'),
(1001, 'admin', 'admin', 'admin@gmail.com', 'admin', 'deactivate'),
(1002, 'rifki', '123', 'rifiki@gmail.com', 'user', 'offline');
...
--
ALTER TABLE `users`
  MODIFY `id` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1003;
COMMIT;
